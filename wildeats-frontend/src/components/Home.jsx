...
.hero-mesh{position:absolute;inset:0;background:
  radial-gradient(ellipse 55% 80% at 85% 40%,rgba(244,197,34,.22) 0%,transparent 55%),
  radial-gradient(ellipse 35% 50% at 5% 90%,rgba(255,255,255,.05) 0%,transparent 50%),
  radial-gradient(ellipse 30% 40% at 50% 0%,rgba(176,48,57,.6) 0%,transparent 60%);
  pointer-events:none;}
...
.hero-copy{}
.hero-chip{display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.22);color:rgba(255,255,255,.9);font-size:.78rem;font-weight:700;padding:7px 16px;border-radius:40px;margin-bottom:22px;backdrop-filter:blur(8px);animation:rise .55s ease both;}
...
.hero-h1{font-family:'Unbounded',sans-serif;font-size:clamp(2.6rem,5.5vw,4.4rem);font-weight:900;color:var(--white);line-height:1.08;margin-bottom:20px;letter-spacing:-.02em;animation:rise .55s .1s ease both;}
.hero-h1 em{font-style:normal;color:var(--gold);}
.hero-p{font-size:1.05rem;color:rgba(255,255,255,.8);max-width:420px;margin-bottom:36px;line-height:1.75;animation:rise .55s .2s ease both;}
.hero-btns{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:52px;animation:rise .55s .3s ease both;}
.hero-proof{display:flex;align-items:center;gap:20px;animation:rise .55s .4s ease both;}
...
.hcard{position:absolute;background:var(--white);border-radius:20px;padding:18px;box-shadow:var(--shadow-lg);animation:rise .55s ease both;}
.hcard-main{width:220px;top:20px;right:0;animation-delay:.2s;}
.hcard-side{width:180px;top:130px;right:60px;animation-delay:.35s;background:var(--gold);}
.hcard-bot{width:160px;top:230px;right:20px;animation-delay:.5s;}
...
.fe1{top:8%;left:48%;font-size:2.2rem;animation-delay:0s;}
...
.pb1{width:88px;height:88px;font-size:2.3rem;animation-delay:0s;}
...
@media(max-width:640px){
  ...
  .nav-links .nav-cta,.nav-links .nav-link:not(.nav-cart):not(.on){display:none;}
        ...
        {/* <nav className="navbar">
          <div className="container nav-inner">
            ...
            <ul className="nav-links">
              <li><a className="nav-link on">Home</a></li>
              <li><a className="nav-link">Browse Stalls</a></li>
              <li><a className="nav-link">My Orders</a></li>
              <li>
                <a className="nav-link nav-cart">
                  🛒 <span className="cbadge">2</span>
                </a>
              </li>
              <li className="nav-cta">
                <a className="btn btn-gold btn-sm">Sign In</a>
              </li>
            </ul>
          </div>
        </nav> */}
            ...
            <div className="hero-inner">
              <div className="hero-copy">
                ...
                <div className="hero-btns">
                  <a href="#shops" className="btn btn-gold">Browse Stalls 🐾</a>
              ...
              {shops.map((shop) => (
                <div className="card shop-card" key={shop.id}>
                  ...
                  <div className="shop-body">
                    ...
                    <button className="btn btn-red btn-full">View Menu</button>
                  </div>
                </div>
              ))}
            </div>
            <div className="shops-more">
              <a className="btn btn-outline">See All Campus Stalls →</a>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="promo-wrap">
              <div className="promo-left">
                ...
                <a className="btn btn-gold">Grab the Deal</a>
              </div>
            ...
            <div className="footer-top">
              ...
              <div className="footer-cols">
                <div className="footer-col">
                  <h5>Explore</h5>
                  <ul>
                    <li><a>Browse Stalls</a></li>
                    <li><a>Today's Specials</a></li>
                    <li><a>My Orders</a></li>
                    <li><a>Favorites</a></li>
                  </ul>
                </div>
