...
const Navbar = () => {
  ...
  return (
    ...
    //   {/* <img src="../public/WildeatsLogo.png" alt="Wildeats logo" /> */}
    //   <h1 className="logo">WILDEATS</h1>

    //   <div className="nav-links">
    //       <a href="/"> Home </a>
    //       <a href="/browse-shop"> Browse Shop </a>
    ...
    <nav className="navbar">
      <div className="container nav-inner">
        ...
        <div className="nav-links">
          <a href="/"><span className="nav-link">Home</span></a>
          <a href="/browse-shop"><span className="nav-link on">Browse Stalls</span></a>
          <a href="/my-orders"><span className="nav-link">My Orders</span></a>
          <a href="/cart"><span className="nav-link">🛒 <span className="cbadge">2</span></span></a>
